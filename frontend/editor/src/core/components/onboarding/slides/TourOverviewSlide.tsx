    ...
    body: (
      <span className={styles.bodyCopyInner}>
        <Trans
          ...
          defaults="TreelifePDF V2 ships with dozens of tools and a refreshed layout. Take a quick tour to see what changed and where to find the features you need."
