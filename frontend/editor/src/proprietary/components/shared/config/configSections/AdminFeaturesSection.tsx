          ...
          <Stack gap="md">
            ...
            <Text size="xs" c="dimmed">
              {t(
                ...
                'Configure server-side certificate generation for "Sign with TreelifePDF" functionality',
              )}
            </Text>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <Text size="xs" c="dimmed" mt={4}>
                  {t(
                    ...
                    'Enable server-side certificate for "Sign with TreelifePDF" option',
                  )}
                </Text>
              </div>
              <Group gap="xs">
